...
url = f'https://waterservices.usgs.gov/nwis/iv/?format=json&sites={ids}&siteStatus=all&startDT={startDate}T00:00:00Z&endDT={endDate}T23:59:59Z'
print(f"URL: {url}")
...
if response.status_code == 200:
    ...
    for series in data['value']['timeSeries']:
        ...
        print(f'Process site: {site_id}', f'variable_type: {variable_type}')
    ...
    with open('../realtime/usgs.csv', 'w', newline='') as csvfile:
    ...
    print(f"Data saved to realtime/usgs.csv")
else:
